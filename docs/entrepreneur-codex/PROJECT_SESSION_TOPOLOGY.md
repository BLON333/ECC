...
| Insurance Automation — Build | `C:\Dev\products\insurance-form-automation` | Own, build, test, and improve the insurance-assistance software. It contains software, not live client working memory. Governed writes use that repository's authorized worktree lane. |
